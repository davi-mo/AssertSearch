...
return [
    ...
    */
    ...
    'default_for_embeddings' => env('AI_EMBEDDINGS_PROVIDER', 'embeddings'),
    ...
    */
    ...
    'providers' => [
        ...
        'embeddings' => [
            'driver' => 'openai',
            'key' => env('EMBEDDING_API_KEY', 'ollama'),
            'url' => env('EMBEDDING_BASE_URL', 'http://host.docker.internal:11434/v1'),
            'models' => [
                'embeddings' => [
                    'default' => env('EMBEDDING_MODEL', 'nomic-embed-text'),
